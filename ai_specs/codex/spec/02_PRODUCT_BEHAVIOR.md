...
Authenticated users enter `/dashboard`, which fetches only their applications. They can search by company/position, switch board/list views, add or edit in a modal, upload files, delete after confirmation, open profile controls, log out, and submit a review for moderation.
